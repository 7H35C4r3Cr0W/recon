...
def test_tool_panel_switches_to_http_builder(qtbot: QtBot, tmp_path: Path) -> None:
    ...
    # a module without a dedicated panel (rpcbind) falls back to the generic hints page
    tp.show_service(
        DiscoveredService(111, Proto.TCP, "rpcbind"), _ref(module="rpcbind", label="rpcbind")
    )
