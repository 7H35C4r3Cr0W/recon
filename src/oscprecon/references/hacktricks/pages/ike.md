...
![Discover the service using nmap - Finding a valid transformation: /ikeforce.py No parameters are required for scan -h for additional help](<../images/image (617).png>)
...
![Bruteforcing ID with ikeforce - Sniffing ID: (From the book Network Security Assessment: Know Your Network ): It is also possible to obtain valid usernames by sniffing the connection...](<../images/image (891).png>)
